...
The project aims to discover interesting facts about actors, movies, etc. using data provided by IMDb\footnote{Internet Movie Database, \url{www.imdb.com}}, using algorithms appropriate specific space and time requirements.\marginpar{rewrite}
